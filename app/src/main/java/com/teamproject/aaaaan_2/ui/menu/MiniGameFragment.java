...
public class MiniGameFragment extends Fragment {
    ...
    private TabLayout mini_game_tab;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mini_game_tab = (TabLayout) rootView.findViewById(R.id.mini_game_tab);
        mini_game_tab.addTab(mini_game_tab.newTab().setText("제비뽑기"));
        mini_game_tab.addTab(mini_game_tab.newTab().setText("숫자야구"));

        final ViewPager pager = (ViewPager) rootView.findViewById(R.id.mini_game_view);
        final MiniGameFragmentAdapter adapter = new MiniGameFragmentAdapter(getChildFragmentManager(), mini_game_tab.getTabCount());
        pager.setAdapter(adapter);
        pager.addOnPageChangeListener(new TabLayout.TabLayoutOnPageChangeListener(mini_game_tab));
        mini_game_tab.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            @Override
